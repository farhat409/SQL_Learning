...
insert into hospitals values (5, 'Duke Hospital', 'New York', 17194440022);

insert into Doctors values ('D1', 'Ragav', 'Jain', 'Physician', 'male', to_date('10-01-1990','dd-mm-yyyy'), 150000, 5);
...
insert into Patients values ('P6', 'Reshal', 'Verma', 'Female', to_date('10-05-1990', 'dd-mm-yyyy'), 9990099905, 'A+');
...
update hospitals
set hospital_code = 6,location='sea road'
